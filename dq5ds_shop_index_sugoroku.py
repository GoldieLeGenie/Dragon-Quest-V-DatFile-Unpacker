...
def read_shop_indexs_sugoroku(file_path, output_path):
    try:
        shop_indexes = []
...
file_path = "./LEVELDATA/dq5ds_shop_index_sugoroku.dat"
output_path = "./data/dq5ds_shop_index_sugoroku.json"
read_shop_indexs_sugoroku(file_path, output_path)
