...
def read_shop_index2(file_path, output_path):
    try:
        shop_indexes = []
...
file_path = "./LEVELDATA/dq5ds_shop_index_2.dat"
output_path = "./data/dq5ds_shop_index_2.json"
read_shop_index2(file_path, output_path)
