...
def read_partytalk_ending_index(file_path, output_path):
    try:
        partytalk_list = []
...
file_path = "./LEVELDATA/dq5ds_partytalk_ending_index.dat"
output_path = "./data/dq5ds_partytalk_ending_index.json"
read_partytalk_ending_index(file_path, output_path)
