...
def read_shop_data_sugoroku(file_path,json_path, output_path):
    try:  
...
file_path = "./LEVELDATA/dq5ds_shop_data_sugoroku.dat"  
output_path = "./data/dq5ds_shop_data_sugoroku.json"
json_path = "./data/items_shop.json"
read_shop_data_sugoroku(file_path, json_path, output_path)
