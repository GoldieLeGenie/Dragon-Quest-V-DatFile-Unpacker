...
import struct
import json
def read_shop_data2(file_path,json_path, output_path):
    try:  
...
file_path = "./LEVELDATA/dq5ds_shop_data_1.dat"  
output_path = "./data/dq5ds_shop_data_1.json"
json_path = "./data/items_shop.json"
read_shop_data2(file_path, json_path, output_path)
